...
class Styleguide_Front {
	...
	public function load_all_scripts() {
		...
		if( isset( $styleguide ) && $styleguide === 'true' ) {
			...
			wp_enqueue_script('app', STYLEGUIDE__PLUGIN_URL . 'front/build/app.js', array(), '1.0.0', true);
			...
			wp_enqueue_style( 'styles', STYLEGUIDE__PLUGIN_URL . 'front/build/styles.css', array( 'dashicons' ) );
		}
